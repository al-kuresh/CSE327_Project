        ...
        if ($user = $result->fetch_assoc()) {
            ...
            if ($stmt->execute()) {
                ...
                if (!$stmt) {
                    ...
                    $type = 'cash_in';
                    $description = "Cash In: $amount via $payment_method";
                ...
                $message = "Failed to cash in: " . $db->error;
            }
        } else {
...
<head>
    ...
    <title>Cash In Confirmation - Mobile Wallet</title>
...
<body>
    ...
    <div class="container mt-3">
        <h2 class="fs-4">Cash In Confirmation</h2>
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="card">
                    <div class="card-body p-3">
                        ...
                        <?php endif; ?>
                        <a href="cash_in.php" class="btn btn-primary btn-sm">Cash In Again</a>
